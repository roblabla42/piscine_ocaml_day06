...
(*                                                +#+#+#+#+#+   +#+           *)
(*   Created: 2015/06/24 15:12:43 by roblabla          #+#    #+#             *)
(*   Updated: 2015/06/24 15:46:11 by roblabla         ###   ########.fr       *)
(*                                                                            *)
(* ************************************************************************** *)
...
module MakeEvalExpr : MAKEEVALEXPR = functor (Val : VAL) ->
    struct
        type t = Val.t
        type expr = Value of t | Add of expr * expr | Mul of expr * expr
...
let fe = FloatEvalExpr.Add (FloatEvalExpr.Value 41.5, FloatEvalExpr.Value 0.98)
